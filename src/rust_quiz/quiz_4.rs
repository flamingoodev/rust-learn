...
// Correct! The program is guaranteed to output: 54
...
// Here the expression (0, 1, ..) is a tuple with three elements, the third one having
// type RangeFull.
//
// On the other hand in a pattern, .. is used to mean "any number of elements".
// So the pattern (.., x, y) matches a tuple with 2 or more elements,
...
//
// The expression b"066" is a byte-string literal of type &'static [u8; 3] containing the three
// ASCII bytes b'0', b'6', b'6'.
//
...
// When printed, we see the decimal representation of the byte value of the ASCII digit 6,
// which is the number 54.
